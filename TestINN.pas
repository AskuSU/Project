...
begin
  ...
  if length(kompaniya.Name)>26 then
    begin
      kompaniya.Name2:=copy(kompaniya.Name,27,length(kompaniya.Name));
      delete(kompaniya.Name, 27,length(kompaniya.Name));
    end;
    ...
    begin
      ...
      for i := 1 to length(SpisokKomp)-1 do
        begin
          ...
          WriteDataToExcel(SpisokKomp[i].Name2,i+1,3);
          WriteDataToExcel(SpisokKomp[i].Name_long,i+1,12);
